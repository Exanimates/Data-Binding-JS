    ...
    Model = function() {
        function e(t, n) {
            ...
            i.forEach(function(e) {
                var t = e.dataset.bind,
                    n = r.get(t),
                    i = r.register(e)
                n && i && i(t, n), "function" == typeof i && r.subscribe(i)
            })
        }
        return _createClass(e, [{
            ...
            value: function(e, t) {
                ...
                try {
                    for (var o, a = Object.keys(e)[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) {
                        var u = o.value,
                            s = t ? t + "." + u : u "object" != _typeof(e[u]) ? this.values.set(s, e[u]) : this._initMap(e[u], s)
                    }
                } catch (c) {
                    r = !0, i = c
                } finally {
            ...
            value: function(e) {
                var t = this,
                    n = e.dataset.bind
                if (!(e instanceof HTMLInputElement)) return function(t, r) {
                    t == n && r != e.innerText && (e.innerText = r)
                }
                switch (e.type) {
                    case "checkbox":
            ...
            key: "set",
            value: function(e, t) {
                this.values.set(e, t), this.listeners.forEach(function(n) {
                    return n(e, t)
                })
            }
        }, {
            ...
            value: function() {
                var e = {}
                return this.values.forEach(function(t, n) {
                    for (var r = e, i = n.split("."), o = 0; o < i.length - 1; o++) r = r[i[0]] || (r[i[0]] = {})
                    r[i[i.length - 1]] = t
                }), e
            }
        }]), e
